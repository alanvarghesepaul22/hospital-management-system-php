        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger active" style="margin-right: 40px;" href="contact.php">Contact</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" style="margin-right: 40px;" href="about.php">About</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" style="margin-right: 40px;" href="login.php">Login</a>
                    </li>
                </ul>
            </div>
        </div>
